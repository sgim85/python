'''
Source: https://github.com/MicrosoftLearning/mslearn-ai-language/blob/main/Instructions/Labs/07-speech.md
...
def TellTime():
    ...
    # [Optional xml] Speech Synthesis Markup Language (SSML) enables you to customize the way your speech is synthesized using an XML-based format.
    responseSsml = " \
